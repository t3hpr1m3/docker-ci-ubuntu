...
[![Gitlab pipeline status (self-hosted)](https://git.dubzland.net/jdubz/docker-ci-ubuntu/badges/main/pipeline.svg)](https://git.dubzland.net/jdubz/docker-ci-ubuntu)
