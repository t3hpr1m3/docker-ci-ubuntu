...
[![Gitlab pipeline status (self-hosted)](https://git.dubzland.net/jdubz/docker-ci-ubuntu/badges/bionic/pipeline.svg)](https://git.dubzland.net/jdubz/docker-ci-ubuntu)
